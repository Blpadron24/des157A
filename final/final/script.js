(function(){
    ...
    var audio3= new Audio('audio/switchplyr.mp3');
    const bgImage =document.getElementById('backgroundimg');
//script to load a random image when page loads
    var image= new Array();
    image[0]="images/newbgimgwidecow.svg";
    image[1]="images/newbgimgwidepig.svg";
    image[2]="images/newbgimgwide2.svg";
...
console.log(x);
    ...
    bgImage.innerHTML= `<img src="${image[x]}">`;
...
function setUpTurn() {
    document.getElementById('flashskip1').className = 'hidden';
    document.getElementById('flashskip2').className = 'hidden';
    game.innerHTML = `<p id="playerUp" class=""> ${gameData.players[gameData.index]} is up, roll the dice</p>`;
    if(gameData.index=== 0){
         rAgain1.innerHTML ='<section id="rollp1" class="rollp1"><div id="flashroll1" class="flashroll1"></div></section>';
        ...
        rAgain2.innerHTML ='<section id="rollp2" class="rollp2"><div id="flashroll2" class="flashroll2"></div></section>';
...
function throwDice(){
        ...
        if(gameData.index=== 0){
        rAgain1.innerHTML ='<section id="ragainp1" class="rollp1"> <div id="flashroll1" class="flashroll1"></div></section>';
        rAgain2.innerHTML ='<section id="ragainp2" class="rollp2"></section>';
        }
        else{
        rAgain1.innerHTML ='<section id="ragainp1" class="rollp1"> </section>';
        rAgain2.innerHTML ='<section id="ragainp2" class="rollp2"><div id="flashroll2" class="flashroll2"></div></section>'; 
        }
   ...
   // if neither die is a 1...
    ...
    function checkWinningCondition() {
		if (gameData.score[gameData.index] >= gameData.gameEnd) {
            ...
            if(x===0){
                document.getElementById('overlay0').className='overlay';

            }
            else if(x===1){
                document.getElementById('overlay1').className='overlay';
            ...
            document.getElementById('gamecontrol').innerHTML= '<div id="flash" class="flashplay"><p id="quit" class="">PLAY</p></div>';
    ...
    function skipTurn(){
        ...
        if(gameData.index=== 0){
           document.getElementById('flashskip1').className = 'flashskip1';
            ...
            document.getElementById('flashskip2').className = 'flashskip2';
